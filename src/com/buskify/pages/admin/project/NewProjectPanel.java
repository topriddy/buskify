...
public class NewProjectPanel extends Panel {
	...
	private class NewProjectForm extends Form{
		...
		public NewProjectForm(String id){
			...
			add(new FormComponentFeedbackBorder("title_border").add(new TextField<String>("title").setRequired(true)));
			add(new FormComponentFeedbackBorder("max_border").add(new TextField<Integer>("max").setRequired(true)));
			add(new FormComponentFeedbackBorder("description_border").add(new TextArea<String>("description").setRequired(false)));
			
			ChoiceRenderer supervisorCR = new ChoiceRenderer("title", "id");
			final DropDownChoice<Supervisor> supervisorChoice = new DropDownChoice<Supervisor>("supervisor",new PropertyModel(this, "supervisor"),supervisorList, supervisorCR);
			...
			add(new Button("saveAndNew"){
				...
				public void onSubmit() {
					...
					NewProjectForm.this.setModel(new CompoundPropertyModel<Project>(projectModel));
					supervisor = null;
				}
			});
		}
